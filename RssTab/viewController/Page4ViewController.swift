...
class Page4ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, XMLParserDelegate  {
    //テーブルビューインスタンス作成
    var tableView: UITableView  =   UITableView()
    let sectionTitle: NSArray = ["経済ニュース"]
    let feedUrl = URL(string: "https://headlines.yahoo.co.jp/rss/all-bus.xml")!
