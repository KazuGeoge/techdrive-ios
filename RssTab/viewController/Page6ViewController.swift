...
class Page6ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, XMLParserDelegate  {
    //テーブルビューインスタンス作成
    var tableView: UITableView  =   UITableView()
    let sectionTitle: NSArray = ["スポーツニュース"]
    ...
    let feedUrl = URL(string: "https://headlines.yahoo.co.jp/rss/all-c_spo.xml")!
