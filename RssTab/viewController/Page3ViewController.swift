...
class Page3ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, XMLParserDelegate  {
    //テーブルビューインスタンス作成
    var tableView: UITableView  =   UITableView()
    let sectionTitle: NSArray = ["国際ニュース"]
    let feedUrl = URL(string: "https://headlines.yahoo.co.jp/rss/all-c_int.xml")!
